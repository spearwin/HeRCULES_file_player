...
POINT_CLOUD_REGISTER_POINT_STRUCT(
    ...
    (float, x, x)(float, y, y)(float, z, z)(float, intensity, intensity)(
        uint32_t, t, t)(uint16_t, reflectivity,
                        reflectivity)(uint16_t, ring, ring)(uint16_t, ambient,
                                                            ambient))
...
POINT_CLOUD_REGISTER_POINT_STRUCT(
    ...
    (float, x, x)(float, y, y)(float, z, z)(float, intensity, intensity)(
        ...
        int32_t, time_offset_ns, time_offset_ns)(uint8_t, line_index,
                                                 line_index))
...
POINT_CLOUD_REGISTER_POINT_STRUCT(
    ...
    (float, x, x)(float, y, y)(float, z, z)(uint8_t, reflectivity,
        ...
        uint32_t, line, line)(uint32_t, offset_time, offset_time))
...
POINT_CLOUD_REGISTER_POINT_STRUCT(
    ContinentalPointXYZIRT,
    (float, x, x)(float, y, y)(float, z, z)(float, v, v)(float, r, r)(
        int8_t, RCS, RCS)(float, azimuth, azimuth)(float, elevation, elevation))
...
POINT_CLOUD_REGISTER_POINT_STRUCT(
    ContinentalXYZV,
    (float, x, x)(float, y, y)(float, z, z)(float, vx, vx)(float, vy, vy))
...
class ROSThread : public QThread {
 ...
 private:
  ...
  std::map<int64_t, geometry_msgs::PoseStamped> pose_gt_data_;
  ...
  DataThread<int64_t> pose_gt_thread_;
